function [U, V,r_bpmf] = ProbMF3(CTr, CTe, D, tensor, i, randMisPos)
...
if i <3
    ...
    percentage1 = (size(unique(randMisPos(:,i)),1)/tensor.size(i))/total_val;
    percentage2 = (size(unique(randMisPos(:,i+1)),1)/tensor.size(i+1))/total_val;
