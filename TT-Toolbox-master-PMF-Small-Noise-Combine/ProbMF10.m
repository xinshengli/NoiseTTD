function [U, V,r_bpmf] = ProbMF10(CTr, CTe, RANK, tensor, i, randMisPos, noiseDensity, sampleNum, randU, randV)
...
% 
% sec_sample = round(total_Sample*percentage)
fir_sample = sampleNum(1)/3;
sec_sample = sampleNum(2)/3;
